		...
		<div class="panel-group" id="accordion">
			...
			<aside class="article-aside clearfix">
											<dl class="article-info  muted">
												...
												<h5>제목:  ${article.quest_title}</h5>
												<hr>
													<i class="fa fa-user"></i>
													<span itemprop="name">작성자 : ${article.quest_writer}</span>
												...
												<dd class="published hasTooltip" title="" data-original-title="Published: ">
													...
													<time datetime="2019-10-02 14:16:02" itemprop="datePublished">작성일 : ${article.quest_date}</time>
												</dd>
												<dd class="hits">
													<i class="fa fa-eye"></i>
			...
			<section class="article-intro clearfix" itemprop="articleBody">
											<div style="clear:both">
												<div>
												${article.quest_content}
												</div>											
												</div>
												
												<div class="pagination" style="float:right;">
													<a href="/Plz_Windows/writeForm.do?num=${article.quest_number}&ref=${article.ref}&re_step=${article.re_step}&re_level=${article.re_level}" class="page">답글</a>
													<a href="/Plz_Windows/writeUpdate.do?num=${article.quest_number}&pageNum=${pageNum}" class="page">수정</a>
													<a href="/Plz_Windows/deletePro.do?num=${article.quest_number}&pageNum=${pageNum}" class="page">삭제</a>
													<a href="/Plz_Windows/question.do" class="page">목록</a>
												</div>
										</section>
